        ...
        bot.commands.baconCommand = {
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    API.sendChat("What would you like me to say?");
                }
            }
        }; // big
        ...
        bot.commands.rogCommand = {
            ...
            functionality: function (chat, cmd) {
                ...
                if (!bot.commands.executable(this.rank, chat)) return void (0);
                    ...
                    var quotes = [ "RogieRog IN THE HOUSE!", "Roger is the greatest!", "Have I ever told you how awesome Roger is?", "Roger, Roger. Whats our vector, Victor?" ];
                    API.sendChat("/me " + quotes[Math.floor(Math.random() * quotes.length)]);
                }
            }
        }; // rog
